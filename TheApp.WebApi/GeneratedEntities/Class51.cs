namespace TheApp.WebApi.GeneratedEntities
{
    [Exposed("Class51")]
    public class Class51
    {
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class19Ref")]
		public int? Class19RefId {get;set;}
		public Class19 Class19Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class92Ref")]
		public int? Class92RefId {get;set;}
		public Class92 Class92Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class96Ref")]
		public int? Class96RefId {get;set;}
		public Class96 Class96Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class70Ref")]
		public int? Class70RefId {get;set;}
		public Class70 Class70Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class59Ref")]
		public int? Class59RefId {get;set;}
		public Class59 Class59Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class1Ref")]
		public int? Class1RefId {get;set;}
		public Class1 Class1Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class43Ref")]
		public int? Class43RefId {get;set;}
		public Class43 Class43Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class50Ref")]
		public int? Class50RefId {get;set;}
		public Class50 Class50Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class8Ref")]
		public int? Class8RefId {get;set;}
		public Class8 Class8Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class45Ref")]
		public int? Class45RefId {get;set;}
		public Class45 Class45Ref {get;set;}
		...
		[System.ComponentModel.DataAnnotations.Schema.ForeignKey("Class56Ref")]
		public int? Class56RefId {get;set;}
		public Class56 Class56Ref {get;set;}
